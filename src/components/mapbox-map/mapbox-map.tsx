...
mapboxgl.accessToken ="pk.eyJ1IjoiZWxvenp5IiwiYSI6ImNrenZ1MGl5YjZueTEyb28xcjRmZXc0Z2IifQ.INMnhgNlxvunYN6qofi3yA"
  ...
  useEffect(() => {
    ...
    currentMap?.on('load', () => {
      ...
      [
        ...
        currentMap?.loadImage(image, (err: any, img: any) => {
          if (err) throw err;
